<template>
    <section class="smoothiecards">
        <!-- <article class="smoothiecard">
            <figure class="smoothiecard__figure">
                <img src="/img/img-1.jpg" alt="" class="smoothiecard__img" />
            </figure>

            <div class="smoothiecard__body">
                <h3 class="smoothiecard__category">SMOOTHIE</h3>
                <h4 class="smoothiecard__title">naslov nekog smoothie</h4>
            </div>

            <footer class="smoothiecard__footer">
                <div class="smoothiecard__min">
                    <svg
                ...
                <div class="smoothiecard__bookmark">
                    <svg
                        class="smoothiecard__bookmark"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 class="smoothiecards__title">SMOOTHIES</h1>
        <template>
            <SmoothieCard />
            <SmoothieCard />
            <SmoothieCard />
