            ...
            <div class="ingredients__pic">
              <figure class="ingredients__pic-imgwrapper">
                <img
                  ...
                  :alt="ingredient.name | altFormatting(ingredient.name)"
                />
              </figure>

              <div class="ingredients__pic-iconwrapper icontainer--bgwhite">
                <svg
                ...
                >
                  <defs>
                    ...
                    >
                      <stop offset="0" stop-color="var(--clr_grd_1)" />
                      <stop offset="1" stop-color="var(--clr_grd_2)" />
                    </linearGradient>
                    <filter
                      id="c"
                      x="0"
